...
export const faqPageContent: FaqPageContent = {
  hero: {
    ...
    subtitle:
      "Nếu bạn chưa tìm thấy câu trả lời, hãy liên hệ trực tiếp với chúng tôi.",
  },
  categories: [
    { id: "services", label: "Về dịch vụ ProsFIN" },
    { id: "process", label: "Về quy trình và cách làm" },
    { id: "pricing", label: "Về phí và thanh toán" },
    { id: "security", label: "Về bảo mật dữ liệu" },
    { id: "legal", label: "Về phạm vi trách nhiệm & pháp lý" },
  ],
  items: [
    {
      id: "faq-1",
    ...
    },
    {
      ...
      answerLong:
        "Không. ProsFIN không yêu cầu hợp đồng dài hạn bắt buộc. Bạn có thể chọn làm việc theo dự án hoặc theo tháng, tùy vào nhu cầu. Chúng tôi tin rằng giá trị dịch vụ sẽ tự nói lên, và bạn sẽ muốn tiếp tục đồng hành vì thấy được kết quả thực tế. Nếu bạn muốn dừng gói giữa chừng, chúng tôi sẽ thanh toán theo tỷ lệ thời gian đã sử dụng.",
    },
    {
      id: "faq-7",
      categoryId: "security",
    ...
    },
    {
      ...
      answerLong:
        "Không. ProsFIN không cam kết hay hứa hẹn về lợi nhuận hay kết quả tài chính cụ thể. Chúng tôi cung cấp tư vấn dựa trên số liệu thực tế và kinh nghiệm, giúp bạn có bức tranh tài chính rõ ràng và đưa ra quyết định sáng suốt hơn. Mọi quyết định cuối cùng đều thuộc về bạn, và kết quả phụ thuộc vào nhiều yếu tố ngoài tầm kiểm soát của chúng tôi. Chúng tôi cam kết làm việc chuyên nghiệp và đưa ra khuyến nghị tốt nhất dựa trên số liệu thực tế.",
    },
    {
      id: "faq-10",
      categoryId: "legal",
      ...
      answerLong:
        "ProsFIN cung cấp tư vấn tài chính và kế toán, không phải dịch vụ kế toán hay kê khai thuế trực tiếp. Chúng tôi không có quyền hạn pháp lý hay quản trị trong doanh nghiệp của bạn. ProsFIN tư vấn và đề xuất dựa trên số liệu thực tế, nhưng quyết định và triển khai thuộc về doanh nghiệp bạn. Chúng tôi không chịu trách nhiệm về các quyết định bạn đưa ra dựa trên tư vấn của chúng tôi. Tuy nhiên, chúng tôi cam kết làm việc chuyên nghiệp và đưa ra khuyến nghị tốt nhất dựa trên số liệu thực tế.",
    },
  ],
};
