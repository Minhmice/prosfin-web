...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    title: "OneLedger™",
    excerpt:
      "Một nguồn dữ liệu duy nhất. Nhiều báo cáo đúng mục tiêu. Chuẩn hóa hệ thống kế toán để CEO/CFO điều hành bằng số liệu thật và sẵn sàng vay/gọi vốn/M&A.",
    shortDescription: "Chuẩn hóa hệ thống kế toán & báo cáo quản trị",
    layoutVariant: "ledger-cockpit-layout",
    configSlug: "oneledger",
    tags: ["chuẩn hóa dữ liệu", "ksnb", "reporting", "m&a readiness"],
    category: "Chuẩn hóa hệ thống",
    ...
    cta: {
      label: "Đăng ký khảo sát OneLedger™ (30’)",
      href: "/services/oneledger#cta",
      variant: "primary",
    },
    sections: [],
    relatedPostIds: [],
    peopleIds: [],
    seeMoreServiceSlugs: ["cleardata", "consulting", "advisor"],
    personas: ["owner", "cfo", "chief-accountant", "finance-team"],
    formats: ["consulting"],
    outcomes: ["compliance", "reporting", "risk"],
    timeToValue: { label: "8–16 tuần", minWeeks: 8, maxWeeks: 16 },
    priority: 2,
    isFeatured: true,
  },
];
